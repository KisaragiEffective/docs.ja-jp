...
|||  
|-|-|  
|<xref:System.Activities.Statements.AddToCollection%601>|指定したコレクションに項目を追加します。|  
|<xref:System.Activities.Statements.ClearCollection%601>|指定したコレクションからすべての項目を削除します。|  
